				...
				<div class="container">
					<div class="row">
						...
						<aside id="secondary" class="col-xs-12 col-md-3 col-md-pull-9">
							<ul class="side-menu">
								<li>
									<a href="<?php echo 'http://localhost/inl%C3%A4mning1/undersida/'; ?>">Undersida</a>
								</li>
								<li>
							    	<a href=<?php echo 'http://localhost/inl%C3%A4mning1/undersida-2/'; ?>>Undersida 2</a>
								</li>
								<li>
								    <a href=<?php echo 'http://localhost/inl%C3%A4mning1/undersida-3/'; ?>>Undersida 3</a>
								</li>
								<li>
								    <a href=<?php echo 'http://localhost/inl%C3%A4mning1/undersida-4/'; ?>>Undersida 4</a> 
								</li>
							</ul>
						</aside>
					</div>
