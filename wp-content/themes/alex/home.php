					...
					<div class="row">
						<div id="primary" class="col-xs-12 col-md-9">
							...
							<img src="<?php echo get_template_directory_uri() . '/images/washington.jpg'; ?>" />
								<h2 class="title">
									<a href=""<?php echo get_template_directory_uri() . '/includes/template-content.php'; ?>"">Det tredje inlägget</a>
								</h2>
								<ul class="meta">
									<li>
							...
							<img src="<?php echo get_template_directory_uri() . '/images/paris.jpg'; ?>" />
								<h2 class="title">
									<a href="file:///C:/Users/alexa/Downloads/labb1-filer/blogg.html">Mitt andra inlägg</a>
								</h2>
								<ul class="meta">
									<li>
										<i class="fa fa-calendar"></i> 1 januari, 2016
									...
									<li>
										<i class="fa fa-user"></i> <a href="author.php">John Doe</a>
									</li>
									<li>
										<i class="fa fa-tag"></i> <a href="category.php">Kategori 1</a>, <a href="category.php">Kategori 3</a>
									</li>
								</ul>
